...
# @option --effort[low|medium|high|max] <level>    Effort level for the current session
...
# @option --permission-mode[acceptEdits|bypassPermissions|default|dontAsk|plan|auto] <mode>  Permission mode to use for the session
