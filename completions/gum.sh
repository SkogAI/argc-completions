...
# @option --padding <0 0>                  Padding ($GUM_CHOOSE_PADDING)
...
# @option --padding <0 0>                  Padding ($GUM_CONFIRM_PADDING)
...
# @option --padding <0 0>                     Padding ($GUM_FILE_PADDING)
...
# @option --padding <0 0>                          Padding ($GUM_FILTER_PADDING)
# @option --limit <1>                              Maximum number of options to pick
# @flag --no-limit                                 Pick unlimited number of options (ignores limit)
# @flag --select-if-one                            Select the given option if there is only one
...
# @option --padding <0 0>                     Padding ($GUM_INPUT_PADDING)
input() {
    :;
}
# }} gum input
...
# @option --padding <0 0>                 Padding ($GUM_SPIN_PADDING)
...
# @option --padding <0 0>                  Padding ($GUM_TABLE_PADDING)
table() {
    :;
}
# }} gum table
...
# @option --padding <0 0>                        Padding ($GUM_WRITE_PADDING)
write() {
    :;
}
# }} gum write
