...
# @option -t --type[`_choice_fstype`] <type>    filesystem type; when unspecified, ext2 is used
# @flag --verbose                               explain what is being done; specifying -V more than once will cause a dry-run
# @flag -h --help                               display this help
# @flag --version                               display version
# @arg device[`_choice_disk`]
