...
# @option -n <num>                        specify the nice value; if POSIXLY_CORRECT flag is set in environment, then the priority is 'relative' to current process priority; otherwise it is 'absolute'
