...
# @flag -r --remaining-time         show remaining time for (dis)charge
# @flag -e --end-time               show end time for (dis)charge
# @option -F --format-time <str>    specify end-time format string
