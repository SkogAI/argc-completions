...
# @option --man <BOOL>                      Whether to check for existence of man pages
# @option --generators <BOOL>               Whether to run unit generators (which requires privileges)
# @option --instance <NAME>                 Specify fallback instance name for template units
# @option --offline <BOOL>                  Perform a security review on unit files
...
# @option --profile <name|PATH>             Include the specified profile in the security review of the units
# @option -U --unit                         Evaluate conditions and asserts of unit
